...
class DealStock(models.Model):
    suser = models.ForeignKey(UserInfo, related_name='suser', verbose_name='卖家',on_delete=models.CASCADE)
    buser = models.ForeignKey(UserInfo, related_name='buser', verbose_name='买家',on_delete=models.CASCADE)
